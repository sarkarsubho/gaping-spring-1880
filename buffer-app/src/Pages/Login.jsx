...
import { SETUSER,LOGIN_SUCCESS } from "../Redux/AuthReducer/actionTypes";
...
export default function Login() {
      ...
      dispatch(login(params)).then((res) => {
        if (res.data === LOGIN_SUCCESS) {
          ...
          axios
            ...
            .then((r) => {
              console.log(r, "from loguser");
              localStorage.setItem("UserData", JSON.stringify(r.data));
              dispatch({type:SETUSER,payload:r.data})
  ...
  return (
    <Flex maxH={"100vh"} minW={"200vh"} align={"left"} justify={"left"}>
      <Image
        src={abc}
        alt=""
        marginLeft={"-10px"}
      ...
      >
        <Stack align={"left"}>
          <Heading marginTop={"40px"} fontSize={"3xl"} textAlign={"left"}>
            Login
          </Heading>
        </Stack>
