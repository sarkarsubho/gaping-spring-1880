  ...
  return (
        ...
        <Flex gap={"40px"} zIndex={1} wrap={"wrap"}  justifyContent={"center"}>
          ...
          >
            ...
            <Flex>
              <Text> Billed at </Text> <Text fontWeight={"bold"}>$0/year</Text>
            </Flex>
          ...
          >
            ...
            <Text>Add additional channels for $5/month</Text>
            <Flex>
              <Text> Billed at </Text> <Text fontWeight={"bold"}>$60/year</Text>
            </Flex>
          ...
          >
            ...
            <Text>Add additional channels for $10/month</Text>
            <Flex>
              <Text> Billed at </Text>{" "}
              <Text fontWeight={"bold"}>$120/year</Text>
            </Flex>
          ...
          >
            ...
            <Flex>
              <Text> Billed at </Text>{" "}
              <Text fontWeight={"bold"}>$1200/year</Text>
            </Flex>
