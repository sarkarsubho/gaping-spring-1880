import {
  ...
  import abcd from "./Images/image1.png"
  ...
  export default function Signup() {
    ...
    return (
      ...
      <Flex
        ...
        justify={'left'}
        >
         <Image src={abc} alt="" marginLeft={'10px'} maxH={'7vh'} maxW={"200vh"}
            objectFit='cover'/>
        <Stack spacing={1} marginLeft={"0rem"} maxW={'lg'} py={12} px={6}>
          <Stack align={'left'}>
          ...
          <Box
            ...
            p={8}>
            <Stack spacing={0} marginLeft={"-30px"}>
              <HStack >
                <Box>
        ...
        <Image src={abcd} alt="" marginLeft={'120px'} maxH={'100vh'} maxW={"200vh"}
        objectFit='cover'/>
      </Flex>
      </>
